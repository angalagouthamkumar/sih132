      ...
      <main className="auth-content">
        ...
        >
          <div className="auth-card-header">
            <h1 className="auth-title">Buyer Login</h1>
            <p className="auth-subtitle">
              Sign in with your enterprise buyer credentials to manage procurement and bids.
            </p>
          </div>
          ...
          <div className="auth-footer-text">
            <span>Register a new business account? </span>
